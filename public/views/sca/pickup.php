                ...
                <div class="white_shd full">
                    <div class="full graph_head">
                        <div class="d-flex heading1 margin_0">
                            <div class="button_block mr-2"><a href="#" class="btn cur-p btn-outline-dark btn-sm" data-bs-toggle="modal" data-bs-target="#addModal">CREATE</a></div>
                            <div class="button_block mr-2"><a href="export.php" class="btn cur-p btn-outline-dark btn-sm" target="_blank">DOWNLOAD</a></div>
                            <div class="button_block"><a href="import.php" class="btn cur-p btn-outline-dark btn-sm">IMPORT</a></div>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="table-responsive-sm">
                            <table id="example" class="display" style="width:100%">
                                ...
                                <tbody>
                                    <?php
                                    $no = 0;
                                    $sql = mysqli_query($koneksi, "SELECT * FROM sca WHERE status_kurir = 'PICKUP' ORDER BY id_sca DESC") or die(mysqli_error($koneksi));
                                    $total = 0;
                                    $result = array();
                                    ...
                                    ?>
                                        <tr>
                                            <td class="text-left text-dark"><?= $no ?></td>
                                            <td class="text-dark"><?= $data['fullname'] ?></td>
                                            <td class="text-dark"><?= $data['nik'] ?></td>
                                            <td class="text-dark"><?= $data['phone'] ?></td>
                                            <td class="text-dark"><?= $data['zona'] ?></td>
                                            <td class="text-dark"><?= $data['id_kurir'] ?></td>
                                            <td class="text-dark"><?= $data['pass_kurir'] ?></td>
                                            <td class="d-flex">
                                                <div class="button_block "><a href="#" class="btn cur-p btn-warning btn-sm mr-2" data-bs-toggle="modal" data-bs-target="#editModal<?= $data['id_sca'] ?>" style="color: white;">Edit</a></div>
                                                <div class="button_block "><a href="delete.php?id=<?= $data['id_sca'] ?>" onclick="return confirm('Yakin Ingin Menghapus Data?')" class="btn cur-p btn-danger btn-sm">Hapus</a></div>
                                            </td>
                                        </tr>
                                        <!-- Modal Edit -->
